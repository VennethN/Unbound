...
{
    /// <summary>
    /// Component that triggers dialogue when the player touches/collides with this object
    /// </summary>
    public class CollideableDialogueTrigger : BaseCollideable
    {
        ...
        protected override bool CanTrigger()
        {
            ...
            // Don't trigger if dialogue is already active
        ...
        /// <summary>
        /// Performs the dialogue collision action
        /// </summary>
